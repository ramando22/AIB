...
Write-Output "#### Install RStudio Desktop ####"
$binary = Get-ChildItem -recurse "C:\temp\binaries\RStudio Desktop"  -Filter *RStudio-2021.09.2-382.exe*
$binaryFullName = $binary.FullName
echo $binaryFullName
...
cd 'C:\temp\binaries\Anaconda3.8.3 2020.07 x64'
.\Anaconda3-2020.07-Windows-x86_64.exe /InstallationType=AllUsers /S /D=C:\ProgramData\Anaconda3
Start-Sleep -s 50


####ArcGis10.5.0.6491
Write-Output "##ArcGis10.5.0.6491"
cd 'C:\temp\binaries\ArcGis10.5.0.6491\Package'
.\phegis_install_10_5_1.bat
Start-Sleep -s 50

####Ruby_2.5.0
Write-Output "##Ruby_2.5.0"
cd 'C:\temp\binaries\Ruby_2.5.0'
...
cd 'C:\temp\binaries\Oracle_SQLDeveloper-21.4.1.349.1822-x64'
.\Install.cmd
Start-Sleep -s 50

####PowerBI Desktop x86
Write-Output "##PowerBI Desktop x86"
cd 'C:\temp\binaries\PowerBI Desktop x86'
...
####Oracle Instant Client and ODBC Drivers 19.9 x32 and x64
Write-Output "##Oracle Instant Client and ODBC Drivers 19.9 x32 and x64"
cd 'C:\temp\binaries\Oracle Instant Client and ODBC Drivers 19.9 x32 and x64'
.\Install.CMD
Start-Sleep -s 50
